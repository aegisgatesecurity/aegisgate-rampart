...
func TestGenerateProxyCertificate(t *testing.T) {
	...
	proxyCert, err := mgr.GenerateProxyCertificate("api.openai.com")
	if err != nil {
...
func TestCertificateCache(t *testing.T) {
	mgr := NewManager()
	caCert, _ := mgr.GenerateSelfSigned()
	cert, _ := mgr.GenerateProxyCertificate("api.openai.com")
...
func TestClearCache(t *testing.T) {
	mgr := NewManager()
	mgr.GenerateSelfSigned()
	mgr.GenerateProxyCertificate("api.openai.com")
	mgr.CacheCertificate("api.openai.com", nil) // won't cache nil but no panic
